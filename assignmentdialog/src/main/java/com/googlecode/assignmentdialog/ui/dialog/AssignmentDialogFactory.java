...
import com.googlecode.assignmentdialog.ui.composite.AssignmentCompositeIF;
...
public final class AssignmentDialogFactory<T> {
    ...
    /**
     * @param parent {@link Frame} which should be the parent of the {@link AssignmentDialog}.
    ...
    /**
     * @param modal if true the {@link AssignmentDialog} will be set to model.
     * @return the {@link AssignmentDialogFactory}
     */
    ...
    public AssignmentDialogController<T> create() {
        ...
        AssignmentCompositeIF<T> assignmentComposite = assignmentDialog.getAssignmentCompositeController()
    ...
    /**
     * @param assignmentCompositeModel the {@link AssignmentCompositeModel} to set.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param assignmentExecutedListener an {@link AssignmentExecutedListener}.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param visibleFilter an {@link FilterVisible}.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param showLeftRightButtonIcons if set to true the left/right buttons will show pre-configured images.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param leftRightButtonsPosition a {@link LeftRightButtonsPosition}.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param leftRightButtonsVisible a {@link LeftRightButtonsVisible}.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param reorderEnabled if set to false the buttons for moving items up/down in the right table are not shown.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param buttonTextAllToLeft the text which will be displayed on the button 'All to left'.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param buttonTextAllToRight the text which will be displayed on the button 'All to right'.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param buttonTextToLeft the text which will be displayed on the button 'Selected to left'.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param buttonTextToRight the text which will be displayed on the button 'Selected to left'.
     * @return the {@link AssignmentDialogFactory}.
     */
    ...
    /**
     * @param dialogTitle the title of the {@link AssignmentDialog}.
     * @return the {@link AssignmentDialogFactory}.
     */
     ...
     * {@link AssignmentDialogFactory#setTablesSortable(boolean)}.
     *
     * @param sortedColumnIndex the index of the column to sort.
    ...
    /**
     * @param tablesSortable if true both tables are sortable by clicking their headers.
     * @return the {@link AssignmentDialogFactory}.
     */
